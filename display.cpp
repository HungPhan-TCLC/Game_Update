...
void draw_Bg(SDL_Renderer* renderer, int SCREEN_WIDTH, int SCREEN_HEIGHT )
{
    ...
    SDL_Texture *bg1 = loadTexture("Game/File_image/bg1.png", renderer);
...
{
    SDL_Texture *home = loadTexture("Game/File_image/home.png", renderer);
    renderTexture(home, renderer, 25, 450, 75, 30);
    SDL_Texture *returnn = loadTexture("Game/File_image/return.png", renderer);
